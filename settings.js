...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "6Rp3UbDA#_2ElbBWmADMHhsQG1kYrBKX_pOag5aY2ySJadMc0TJQ", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "201554680406",
DEV: process.env.DEV || "201554680406",
